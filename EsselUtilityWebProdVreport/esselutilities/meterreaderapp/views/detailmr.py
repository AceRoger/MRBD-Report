    ...
    try:
        ...
        try:
            ...
            for routeassignment in routeassignments:
                ...
                jobcard = len(MeterReading.objects.filter(jobcard__meterreader=userPofile_obj, jobcard__routeassigned=routeassignment, is_active=True,
                                                     is_deleted=False,
                                                     reading_month=currentmonth,))  # reading_month=currentmonth
...
def get_meterreader(request):
    try:
        ...
        for routeassignment in routeassignments:
            ...
            jobcard = len(MeterReading.objects.filter(jobcard__meterreader=mr_id, jobcard__routeassigned=routeassignment, is_active=True,
                                                     is_deleted=False,
                                                     reading_month=yearMonth,))  # reading_month=currentmonth
...
def reading_export_materreader(request, mr_id, currentmonth):
    try:
        ...
        print 'Exception|detailmr.py|reading_export_materreader', e
        data = {'success': 'false'}
    return HttpResponse(json.dumps(data), content_type='application/json')

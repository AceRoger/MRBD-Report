        ...
        success: function(response) {
            if (response.success == "true") {
                ...
                if (response.validator == 1){
                    window.location.href = "/validate/validation-level-one/" + response.billcycleid + "/" +  response.month + "/";
                }else{
                    window.location.href = "/validate/validation-level-two/" + response.billcycleid + "/" +  response.month + "/";
                }
            }else{

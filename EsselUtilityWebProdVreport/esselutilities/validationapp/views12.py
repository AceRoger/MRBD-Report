...
def validate_jobcard_list(request, month=None):
    ...
    try:
        ...
        data = {'finallists': finallist, 'overAllConsumers': overAllConsumers,
                ...
                'loggedinuser': request.user.userprofile, 'monthinwords': monthh}
    ...
    try:
        ...
        try:
            ...
            data = {'success': 'true', 'validator': request.POST.get('validator'),
                    ...
                    'billcycleid': validatorAssigned.meterreading.jobcard.routeassigned.routedetail.billcycle_id}  # true
            return HttpResponse(json.dumps(data), content_type='application/json')
        except ValidatorAssignment.DoesNotExist:
